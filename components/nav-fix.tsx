...
export default function NavFix(){
  ...
  return <style>{`
    ...
    .main-nav a{display:inline-flex;align-items:center;justify-content:center;min-height:40px;padding:9px 16px;border:1px solid #dfc5aa;border-radius:999px;background:linear-gradient(180deg,#fffaf3,#f7eadc);color:#5b120f!important;text-decoration:none!important;font-weight:800;letter-spacing:.02em;box-shadow:0 6px 16px rgba(91,18,15,.08);transition:transform .18s ease,box-shadow .18s ease,background .18s ease,color .18s ease,border-color .18s ease}
