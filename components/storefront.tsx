...
export default function Storefront(){
  ...
  return <div className="site-shell">
    ...
    <header className="site-header"><div className="wrap nav">
      <Link href="/" className="brand-lockup" aria-label="Tithonia home"><img className="brand-logo" src="/tithonia-logo.svg" alt="Tithonia"/><span className="brand-word"><b>TITHONIA</b><small>MORE THAN FASHION</small></span></Link>
    ...
    <main>
      <section className="hero" id="home"><div className="wrap hero-grid">
        ...
        <div className="hero-art"><div className="silk silk-one"/><div className="silk silk-two"/><div className="label-card"><img src="/tithonia-logo.svg" alt="Tithonia luxury emblem"/><div className="label-domain">www.tithonia.online</div></div><p className="signature">Wear<br/>A Better You</p><div className="hero-box">GOOD<br/>STYLE<br/>BRIGHTER<br/>DAYS</div></div>
      </div></section>
